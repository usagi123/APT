...
void pushStackSLL(int newData){
    struct stackSLL *newNode;
    newNode = (struct stackSLL *)malloc(sizeof(struct stackSLL));
    newNode->newData = newData;
    if(stackSLLHead == NULL){
        newNode->ptr = NULL;
    }
    else{
        newNode->ptr = stackSLLHead;
    }
    stackSLLHead = newNode;
    printf("\nPush succesful.");
    ContinueOrExit();
    return;
}
...
void pushQueueSLL(int newData){
    struct queueSLL *newNode;
    newNode = (struct queueSLL *)malloc(sizeof(struct queueSLL));
    newNode->newData = newData;
    newNode->ptr = NULL;
    if(queueSLLHead == NULL){
        queueSLLHead = newNode;
    }
    else{
        struct queueSLL *temp = queueSLLHead;
        while(temp->ptr != NULL){
...
void pushFrontDoubleEndedQueueSLL(int newData){
    struct doubleEndedQueueSLL *newNode;
    newNode = (struct doubleEndedQueueSLL *)malloc(sizeof(struct doubleEndedQueueSLL));
    newNode->newData = newData;
    if(doubleEndedQueueSLLHead == NULL){
        newNode->ptr = NULL;
    }
    else{
        newNode->ptr = doubleEndedQueueSLLHead;
    }
    doubleEndedQueueSLLHead = newNode;
